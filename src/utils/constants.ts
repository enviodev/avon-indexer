...
export const SECONDS_PER_MONTH = BigInt(2592000);
...
export const LOAN_TOKEN_DECIMALS = BigInt(6);
export const COLLATERAL_TOKEN = "0x84cd9C36ffAf48401425e51206171E98aec9fB6B";
export const COLLATERAL_TOKEN_DECIMALS = BigInt(18);
export const POOL_SHARES_DECIMALS = BigInt(18);
